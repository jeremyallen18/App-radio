...
-- Vinculación de dispositivo + evidencia biométrica en el fichaje (migración
-- 033). Cada cuenta que ficha queda atada a UN dispositivo confiado; el primero
-- se registra por "trust-on-first-use" y cualquier cambio lo aprueba el
-- director. Solo se guardan HASHES (sha256) de los identificadores, nunca el
-- valor crudo.
...
-- Bitácora de auditoría para el API de contenido del sitio público
-- (/site/*). Registra cada create/update/delete para rastrear cambios.
