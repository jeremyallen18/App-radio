    ...
    return SizedBox(
      ...
      child: TweenAnimationBuilder<double>(
        ...
        builder: (context, value, _) => CustomPaint(
          painter:
              _DialPainter(needle: value, stations: AuthStation.values.length),
...
class _DialPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double x = 0; x <= w; x += tickGap) {
      ...
      final major = i % 5 == 0;
      tick.color =
          AppColors.textMuted.withValues(alpha: (major ? 0.6 : 0.3) * edgeFade);
      canvas.drawLine(
          Offset(x, baseY), Offset(x, baseY - (major ? 12 : 6)), tick);
    }
