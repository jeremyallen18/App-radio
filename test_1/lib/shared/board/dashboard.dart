...
class dashb_mem extends StatefulWidget {
  ...
  /// pestaña). Como ruta suelta (`/dashb_mem`) sí los trae.
  const dashb_mem({super.key, this.embedded = false});
  ...
  Future<void> _newDirectorTask() async {
    ...
    if (saved == true && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Tarea enviada al manager del departamento.')),
      );
    }
  }
                ...
                children: [
                  SectionHeader(
                    ...
                    action: FilledButton.icon(
                      onPressed: _departments.isEmpty ? null : _newDirectorTask,
