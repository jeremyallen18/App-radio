              ...
              itemBuilder: (context, index) {
                return TextButton(
                  ...
                  child: Container(
                    ...
                    color: const Color.fromARGB(255, 78, 102, 158),
                    child: Row(
                      children: [
                        const SizedBox(
                          width: 20,
                        ...
                        Text(
                          incompTasks![index]['description'] ?? "No hay tareas",
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          compTasks![index]['description'] ?? "No hay tareas",
                          style: const TextStyle(color: Colors.white),
                        ),
                      ],
                    ),
