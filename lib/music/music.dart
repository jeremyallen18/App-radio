  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 15, 26, 51),
        foregroundColor: Colors.white,
        elevation: 12,
        title: const Text('Zona Zen </>'),
      ),
      body: Column(
        children: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  ...
                  child: MyTextField(
                    ...
                    hintText: 'Nombre de la canción', inputType: TextInputType.name, secure1: false, capital: TextCapitalization.none, labelText2: 'Buscar',
              ...
              //  Buttonkii(buttonName: 'Buscar', onTap: onSearchButtonPressed, bgColor: Colors.black, textColor: Colors.white,)
                ElevatedButton(
            ...
            child: FutureBuilder<List<Track>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return const Center(child: Text('¿Quieres probar algunas canciones?'));
                } else {
