        ...
        child: Column(
          ...
          children: [
            ...
            MultiSelectDialogField<Domain>(
              ...
              selectedItemsTextStyle: TextStyle(color: AppColors.accent, fontWeight: FontWeight.w700),
              ...
              buttonIcon: Icon(Icons.domain_outlined, color: AppColors.textMuted),
              buttonText: Text(
              ...
              confirmText: Text('Confirmar', style: TextStyle(color: AppColors.accentStrong)),
              cancelText: Text('Cancelar', style: TextStyle(color: AppColors.textMuted)),
              onConfirm: (values) {
